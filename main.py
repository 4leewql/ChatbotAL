...
st.set_page_config(page_title= "MI CHAT BOT")
st.title("BIENVENIDO AL CHAT BOT DE ALE")
...
def main():
    ...
    area_chat()
    mensaje = st.chat_input("Escribí un promt")
    ...
    if mensaje:
        ...
        if respuesta_ia:
            with st.chat_message("assitant"):
                ...
                actualizar_historial("assitant", respuesta_ia ,"👾")
                st.rerun()
